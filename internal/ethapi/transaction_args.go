...
func (args *TransactionArgs) setDefaults(ctx context.Context, b Backend) error {
	...
	if args.MaxPriorityFeePerGas == nil || args.MaxFeePerGas == nil {
		...
		if b.ChainConfig().IsLondon(head.Number) && !b.ChainConfig().IsZkEvm(head.Number) && args.GasPrice == nil {
			...
			if args.GasPrice == nil {
				...
				if b.ChainConfig().IsLondon(head.Number) && !b.ChainConfig().IsZkEvm(head.Number) {
